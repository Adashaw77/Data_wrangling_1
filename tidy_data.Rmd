...
pulse_tidy_data = gather(pulse_data, key = visit, value = bdiscore, bdi_score_bl:bdi_score_12m)
```
...
```
select(id, visit, everything(), -starts_with("remove"))  : move "id", "visit" to the right of other variables 
...
##group encodes both dose and day of treatment! Time to fix that 
...
```
tolower: translate upper letter to lower
